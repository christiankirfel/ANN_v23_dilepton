...
plt.xlabel('ANN_D response', horizontalalignment='left', fontsize='large')
plt.title('Normalised')
plt.gcf().savefig('ANN_D_syst_dev.png')
#plt.show()
plt.gcf().clear()
...
def plot_losses(i, losses):
    ...
    plt.legend(loc="upper right")
    plt.grid()
    plt.gcf().savefig('losses' + str(i/5) + '.png')
    plt.gcf().clear()
    #plt.show()
...
plt.xlabel('ANN response', horizontalalignment='left', fontsize='large')
plt.title('Normalised')
plt.gcf().savefig("ANN_syst_dev.png")
#plt.show()
plt.gcf().clear()
